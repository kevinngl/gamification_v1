                ...
                <div class="bg-light border p-3">
                    ...
                    <div class="py-2">
                        ...
                        <div class="progress" style="height: 3px;">
                            <div class="progress-bar bg-success rounded-5" role="progressbar" style="width: 50%;"
                                 aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <input type="hidden" id="usery"
                    ...
                    <div class="bg-light border w-100 p-3" id="question-forms">
                        <div class="p-4">
                            <div class="py-1 w-100 d-flex justify-content-between align-items-start ">
                                ...
                                <div id="timer" class="text-end float-end rounded-pill p-2 shadow-sm border">countdown:
                                    <span id="time-left" class="small"></span></div>
                            ...
                            <div class="option py-4">
                                <ul class="list-group list-group-flush" id="choices-list">
                                    <li class="list-group-item border border-0 py-3 bg-light shadow-sm mb-1">
                                        <input class="form-check-input me-3" type="radio" name="radioNoLabel"
                            ...
                            <div class="pt-3 float-end">
                                <button type="button" class="btn btn-outline-secondary small btn-md  text-dark"
                                        id="next-btn">Next
                                </button>
                            </div>
                        </div>
...
<section>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="modal fade rounded-0" id="badgeModal" tabindex="-1" aria-labelledby="badgeModalLabel"
                     aria-hidden="true">
                    <div class="modal-dialog rounded-0">
                        <div class="modal-content">
                            <div class="modal-header border border-0 rounded-0">
                                ...
                                <button type="button" class="btn-close bg-light rounded-0" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                            </div>
                            <div class="modal-body border border-0 text-center">
                                <p id="badge-earned">No badges earned yet.</p>
                                <img id="badge-image" src="" alt="image awrd here" class="img-fluid"
                                     style="width:100px;height:100px;">
                                <div id="earned-point" class="text-center"></div>
                            </div>
                            <div class="modal-footer">
                                <button id="show-answers-btn" class="btn btn-primary rounded-0 border border-0">
                                    Continue
                                </button>
