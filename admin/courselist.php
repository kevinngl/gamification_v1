                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form class="bg-light" enctype="multipart/form-data" id="updateForm">
                                                            ...
                                                            <input type="text" class="form-control rounded-0" id="name" name="name" aria-describedby="emailHelp" value="">
                                                            ...
                                                            <input type="url" class="form-control" id="link" name="link"placeholder="e.g https://you.tube/qw23w" value="">
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="mb-2">
