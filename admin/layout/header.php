    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="courselist.php">List Courses</a>
                    </div>
                </div>
            </li>
            <!--modules-->
            <li class="nav-item">
                ...
                <div id="ModuleTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Modules Components:</h6>
                        <a class="collapse-item" href="./module.php">Add Modules</a>
                        <a class="collapse-item" href="./modulelist.php">List Modules</a>
                    </div>
                </div>
            </li>
